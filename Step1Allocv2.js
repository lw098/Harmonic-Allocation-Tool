...
//at the moment i just ignored the parameters, but the intention is to make the code more fluent and smaller in future version/iterations
...
function Sub_SP_Step1() {
    ...
    var Trx_Size = document.getElementById('SWER_Trx_Size').value;
    ...
    } else if (document.getElementById("SP_SWERInp").value==="Yes") {
        $("#SWER_Size").show();
        console.log('SWER SIZE WORKS')
        switch (Trx_Size) {
            case '10':
                if (Number(document.getElementById("SP_PowerInp").value) + Number(document.getElementById("SP_GenInp").value) <= 3.5) {
                    $("#resultsSuccessForm").show();
                } else  {
                    $("#resultsFailedForm").show();
                }
                break;
            case '20':
                if (Number(document.getElementById("SP_PowerInp").value) + Number(document.getElementById("SP_GenInp").value) <= 7) {
                    $("#resultsSuccessForm").show();
                } else  {
                    $("#resultsFailedForm").show();
                }
                break;
            case '25':
                if (Number(document.getElementById("SP_PowerInp").value) + Number(document.getElementById("SP_GenInp").value) <= 8.75) {
                    $("#resultsSuccessForm").show();
                } else  {
                    $("#resultsFailedForm").show();
                }
